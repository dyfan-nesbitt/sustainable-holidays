  ...
  const holidays = [
...

    {
      ...
      tags: ["Europe", "City", "Culture", "Food", "History", "Walking", "Scenic", "Hot"],
      description:
...

    {
      ...
      tags: ["Europe", "City", "Beach", "Culture", "Food", "Nightlife", "Walking", "Hot"],
      description:
...

    {
      ...
      tags: ["Europe", "Nature", "Adventure", "Scenic", "Wildlife", "Unique", "Cold"],
...

    {
      ...
      tags: ["Europe", "City", "Culture", "History", "Food", "Romantic", "Walking"],
      description:
...

    {
      ...
      tags: ["Africa", "City", "Culture", "Food", "History", "Adventure", "Hot", "Unique"],
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Nairobi National Park Safari", cost: 60, carbon: 10, time: "Morning" },
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Lekki Conservation Centre", cost: 20, carbon: 1, time: "Morning" },
        { name: "Lagos Island Walking Tour", cost: 15, carbon: 2, time: "Afternoon" },
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "National Museum of Ethiopia", cost: 10, carbon: 0, time: "Morning" },
        { name: "Mercato Market Tour", cost: 0, carbon: 0, time: "Afternoon" },
        { name: "Traditional Coffee Ceremony", cost: 15, carbon: 0, time: "Evening" },
...

    {
      ...
      activities: [
        ...
        { name: "African Renaissance Monument", cost: 10, carbon: 1, time: "Afternoon" },
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Victoria Falls Day Trip", cost: 50, carbon: 15, time: "Day Trip" },
        { name: "South Luangwa Safari", cost: 120, carbon: 20, time: "Day Trip" },
        { name: "Lusaka National Museum", cost: 5, carbon: 0, time: "Morning" },
        { name: "Kabwata Cultural Village", cost: 10, carbon: 0, time: "Afternoon" },
      ],
...

    {
      ...
      activities: [
        ...
        { name: "Tsingy de Bemaraha Trek", cost: 80, carbon: 5, time: "Day Trip" },
...

    {
      ...
      activities: [
        ...
        { name: "Desert Safari & Dune Bashing", cost: 80, carbon: 15, time: "Evening" },
        { name: "Dubai Mall & Fountain Show", cost: 0, carbon: 1, time: "Afternoon" },
        { name: "Dhow Cruise Dinner", cost: 60, carbon: 8, time: "Evening" },
      ],
      tags: ["Asia", "City", "Luxury", "Culture", "Food", "Nightlife", "Unique", "Hot"],
      description:
...

    {
      ...
      activities: [
        ...
        { name: "Marina Bay Sands Skypark", cost: 23, carbon: 1, time: "Afternoon" },
...

    {
      ...
      activities: [
        ...
        { name: "Chandni Chowk Street Food", cost: 20, carbon: 0, time: "Afternoon" },
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Gyeongbokgung Palace Tour", cost: 3, carbon: 1, time: "Morning" },
        { name: "DMZ Day Trip", cost: 60, carbon: 15, time: "Day Trip" },
        { name: "Korean BBQ Cooking Class", cost: 50, carbon: 1, time: "Evening" },
        { name: "Bukchon Hanok Village Walk", cost: 0, carbon: 0, time: "Afternoon" },
      ],
...

    {
      ...
      tags: ["Asia", "Island", "Beach", "Nature", "Culture", "Relaxation", "Scenic", "Hot"],
      description:
...

    {
      ...
      tags: ["South America", "City", "Culture", "Food", "History", "Adventure", "Nightlife"],
...

    {
      ...
      activities: [
        ...
        { name: "La Candelaria Walking Tour", cost: 0, carbon: 0, time: "Morning" },
        { name: "Monserrate Hill Cable Car", cost: 15, carbon: 2, time: "Afternoon" },
        { name: "Street Art Tour Chapinero", cost: 20, carbon: 0, time: "Afternoon" },
      ],
...

    {
      ...
      activities: [
        ...
        { name: "Liberdade Japanese Quarter", cost: 15, carbon: 1, time: "Afternoon" },
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Machu Picchu Day Trip", cost: 120, carbon: 10, time: "Day Trip" },
      ...
      tags: ["South America", "City", "Culture", "History", "Food", "Adventure", "Scenic"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Tango Lesson & Dinner Show", cost: 60, carbon: 1, time: "Evening" },
        { name: "La Boca Neighbourhood Tour", cost: 0, carbon: 0, time: "Afternoon" },
        { name: "Recoleta Cemetery Walk", cost: 0, carbon: 0, time: "Morning" },
        { name: "Asado Steak Dinner Experience", cost: 50, carbon: 2, time: "Evening" },
      ],
      tags: ["South America", "City", "Culture", "Food", "Nightlife", "Music", "Scenic"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "San Cristobal Hill Cable Car", cost: 10, carbon: 1, time: "Morning" },
        { name: "Chilean Wine Valley Tour", cost: 50, carbon: 5, time: "Day Trip" },
        { name: "Torres del Paine Day Trip", cost: 90, carbon: 15, time: "Day Trip" },
        { name: "La Vega Central Market", cost: 0, carbon: 0, time: "Morning" },
      ],
      tags: ["South America", "City", "Nature", "Mountains", "Food", "Scenic", "Adventure"],
      description:
...

    {
      ...
      tags: ["North America", "City", "Culture", "Food", "Nightlife", "Luxury", "Walking", "Iconic"],
      description:
...

    {
      ...
      activities: [
        ...
        { name: "Griffith Observatory Hike", cost: 0, carbon: 0, time: "Morning" },
      ],
      tags: ["North America", "City", "Beach", "Culture", "Food", "Nightlife", "Scenic", "Hot"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Old Montreal Walking Tour", cost: 0, carbon: 0, time: "Morning" },
      ...
      tags: ["North America", "City", "Culture", "Food", "Music", "Walking", "Cold"],
      description:
...

    {
      ...
      tags: ["Australia", "City", "Beach", "Nature", "Adventure", "Scenic", "Luxury", "Hot"],
      description:
...

    {
      ...
      tags: ["Oceania", "City", "Nature", "Adventure", "Hiking", "Scenic", "Luxury"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Federation Square & Street Art", cost: 0, carbon: 0, time: "Morning" },
        { name: "Great Ocean Road Day Trip", cost: 60, carbon: 15, time: "Day Trip" },
        { name: "Melbourne Coffee & Food Tour", cost: 45, carbon: 1, time: "Morning" },
        { name: "Phillip Island Penguin Parade", cost: 30, carbon: 8, time: "Evening" },
      ],
      tags: ["Oceania", "City", "Culture", "Food", "Scenic", "Adventure", "Nature"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "South Bank Parklands Walk", cost: 0, carbon: 0, time: "Morning" },
        { name: "Australia Zoo Day Trip", cost: 59, carbon: 10, time: "Day Trip" },
        { name: "Lone Pine Koala Sanctuary", cost: 38, carbon: 5, time: "Afternoon" },
        { name: "Moreton Island Snorkelling", cost: 70, carbon: 10, time: "Day Trip" },
      ],
      tags: ["Oceania", "City", "Nature", "Wildlife", "Beach", "Adventure", "Hot"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Rottnest Island Day Trip", cost: 35, carbon: 8, time: "Day Trip" },
        { name: "Kings Park Botanical Walk", cost: 0, carbon: 0, time: "Morning" },
        { name: "Fremantle Markets & Port", cost: 20, carbon: 2, time: "Afternoon" },
        { name: "Swan Valley Wine Tour", cost: 55, carbon: 5, time: "Afternoon" },
      ],
      tags: ["Oceania", "City", "Beach", "Nature", "Wine", "Scenic", "Relaxation", "Hot"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Bungee Jumping at Kawarau", cost: 165, carbon: 0, time: "Morning" },
        { name: "Milford Sound Cruise", cost: 80, carbon: 10, time: "Day Trip" },
        { name: "Skyline Gondola & Luge", cost: 55, carbon: 2, time: "Afternoon" },
        { name: "Fiordland Hiking Trail", cost: 0, carbon: 0, time: "Morning" },
      ],
      tags: ["Oceania", "Nature", "Adventure", "Mountains", "Scenic", "Hiking", "Luxury"],
      description:
...

    {
      ...
      transport: "flight",
      activities: [
        { name: "Great Barrier Reef Snorkelling", cost: 80, carbon: 10, time: "Day Trip" },
        { name: "Daintree Rainforest Tour", cost: 55, carbon: 8, time: "Day Trip" },
        { name: "Skyrail Rainforest Cableway", cost: 60, carbon: 1, time: "Morning" },
        { name: "Indigenous Cultural Experience", cost: 35, carbon: 0, time: "Afternoon" },
      ],
      tags: ["Oceania", "Nature", "Beach", "Wildlife", "Adventure", "Scenic", "Hot"],
      description:
...

    {
      ...
      activities: [
        ...
        { name: "Theme Park Day (Warner Bros)", cost: 95, carbon: 5, time: "Day Trip" },
        { name: "Lamington National Park Hike", cost: 0, carbon: 0, time: "Day Trip" },
...

    {
      ...
      activities: [
        ...
        { name: "Mamanuca Islands Day Trip", cost: 65, carbon: 10, time: "Day Trip" },
        { name: "Village Trekking Tour", cost: 30, carbon: 2, time: "Afternoon" },
      ],
      tags: ["Oceania", "Island", "Beach", "Nature", "Relaxation", "Scenic", "Hot", "Unique"],
      description:
...

    {
      ...
      activities: [
        ...
        { name: "Lagoon Shark & Ray Snorkel", cost: 70, carbon: 5, time: "Morning" },
        { name: "Mount Otemanu Hike", cost: 45, carbon: 0, time: "Morning" },
        { name: "Sunset Sailing Cruise", cost: 95, carbon: 5, time: "Evening" },
      ],
      tags: ["Oceania", "Island", "Beach", "Luxury", "Romantic", "Scenic", "Relaxation", "Hot"],
      description:
